...
from Utils.keras_yolo import (space_to_depth_x2,
...
def _main():
    ...
    config_path = 'data/model_data/yolov2.cfg'
    weights_path = 'data/model_data/yolov2.weights'
    ...
    output_path = 'data/model_data/yolo.h5'
